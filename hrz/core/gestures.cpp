...
void on_touch_start(GestureSystem* system, const platform::Event& event)
{
    for (auto gesture_id : system->gestures)
    {
        ...
        if (gesture->finger_count == FingerCount::One)
        {
            ...
            gesture->end_time_ms = hrz::clock::CurrentFrameWallTime.ms;
            ...
            new_gesture->start_time_ms = hrz::clock::CurrentFrameWallTime.ms;
    ...
    gesture->start_time_ms = hrz::clock::CurrentFrameWallTime.ms;
...
void remove_ended_gestures(GestureSystem* system)
{
    ...
    auto now = hrz::clock::CurrentFrameWallTime.ms;
