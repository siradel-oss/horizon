...
struct VisibilitySetBuilder
{
    ...
    void add_repr(
        hrz_proto::VectorRepr::ReprTypeCase type,
        uint64_t repr_id,
...
struct VectorTilesActor : public Actor
{
    ...
    hrz::flat_hash_set<hrz_proto::VectorRepr::ReprTypeCase> _reprs_not_scheduling_instantly;
    hrz::flat_hash_set<hrz_proto::VectorRepr::ReprTypeCase> _reprs_using_z_coordinates;
    ...
    hrz::flat_hash_map<hrz_proto::VectorRepr::ReprTypeCase, ReprSystem::Channel> _repr_channels;
    ...
    ActorStatus work_async(BlobAllocator* ba, JobScheduler* js) override
    {
            ...
            std::visit(
                hrz::overload{
                    ...
                    [&](const to_actor::SetRepresentations& message)
                    {
                        ...
                        {
                            auto type = new_repr.repr_type_case();
                    ...
                    [&](const to_actor::RemoveRepresentation& message)
                    {
                        ...
                        for (const auto& it : _tiles_by_coords)
                        {
                            ...
                            destroy_repr(content.reprs[index], DestroyRepr_All, true);
        ...
        if (_model_status == ModelStatus::Loaded
            ...
            && now_ms >= _last_visibility_set_creation_time_ms + VISIBLITY_SET_RECOMPUTE_DELAY_MS)
        {
            ...
            if (visibility_set.has_value())
            {
                ...
                _last_visibility_set_creation_time_ms = now_ms;
            }
            else
            {
                _generate_new_visibility_set = true;
    ...
    static inline bool repr_is_flat_overlay(hrz_proto::VectorRepr::ReprTypeCase type)
    {
        switch (type)
        {
            case hrz_proto::VectorRepr::ReprTypeCase::kFlatOverlayPoint:
            case hrz_proto::VectorRepr::ReprTypeCase::kFlatOverlayPolyline:
            case hrz_proto::VectorRepr::ReprTypeCase::kFlatOverlayPolygon:
            case hrz_proto::VectorRepr::ReprTypeCase::kHeatmap: return true;

            case hrz_proto::VectorRepr::ReprTypeCase::kCylinder:
            case hrz_proto::VectorRepr::ReprTypeCase::kExtrudedGeometry:
            case hrz_proto::VectorRepr::ReprTypeCase::kModel:
            case hrz_proto::VectorRepr::ReprTypeCase::REPR_TYPE_NOT_SET:
            case hrz_proto::VectorRepr::ReprTypeCase::kSymbol: return false;
