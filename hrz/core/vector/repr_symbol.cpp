...
private:
    ...
    hrz::flat_hash_map<hrz_proto::SymbolElement::ElementTypeCase, std::unique_ptr<ElementSystem>>
        _element_systems;
...
public:
    SymbolReprSystem()
    {
        ...
        _element_systems.insert(
            {hrz_proto::SymbolElement::ElementTypeCase::kFlex,
             std::unique_ptr<ElementSystem>(new FlexElementSystem())});
        _element_systems.insert(
            {hrz_proto::SymbolElement::ElementTypeCase::kFlexible,
        ...
        _element_systems.insert(
            {hrz_proto::SymbolElement::ElementTypeCase::kAlign,
             std::unique_ptr<ElementSystem>(new AlignElementSystem())});
        _element_systems.insert(
            {hrz_proto::SymbolElement::ElementTypeCase::kConstrainedBox,
             std::unique_ptr<ElementSystem>(new ConstrainedBoxElementSystem())});
        _element_systems.insert(
            {hrz_proto::SymbolElement::ElementTypeCase::kRotatedBox,
        ...
        _element_systems.insert(
            {hrz_proto::SymbolElement::ElementTypeCase::kAspectRatio,
             std::unique_ptr<ElementSystem>(new AspectRatioElementSystem())});
        _element_systems.insert(
            {hrz_proto::SymbolElement::ElementTypeCase::kFittedBox,
        ...
        _element_systems.insert(
            {hrz_proto::SymbolElement::ElementTypeCase::kLeaderLine,
             std::unique_ptr<ElementSystem>(new LeaderLineElementSystem())});
        _element_systems.insert(
            {hrz_proto::SymbolElement::ElementTypeCase::kOptional,
             std::unique_ptr<ElementSystem>(new OptionalElementSystem())});
        _element_systems.insert(
            {hrz_proto::SymbolElement::ElementTypeCase::kVariant,
    ...
    std::optional<ConfigH> register_style(
        ...
        ConfigId style_id)
    {
        if (repr.repr_type_case() != hrz_proto::VectorRepr::ReprTypeCase::kSymbol)
        {
        ...
        const hrz_proto::SymbolElement& descriptor)
    {
        ...
        config->elements.push_back({{descriptor.element_type_case(), 0}, parent_index, {}, {}, {}});

        bool is_anchor =
            descriptor.element_type_case() == hrz_proto::SymbolElement::ElementTypeCase::kAnchor;
        ...
        assert(_element_systems.find(descriptor.element_type_case()) != _element_systems.end());
        auto& element_system = _element_systems.at(descriptor.element_type_case());
        ...
        if (element_system->is_visual())
        {
            ...
            else
            {
                HRZ_LOG_WARNING(
                    ...
                    (int)descriptor.element_type_case());
            }
        }
