...
template<typename PrototypeT, hrz_proto::SymbolElement::ElementTypeCase ELEMENT_TYPE>
struct LayoutElementSystem : public ElementSystem
{
protected:
    using Prototype = PrototypeT;
    static constexpr hrz_proto::SymbolElement::ElementTypeCase ElementType = ELEMENT_TYPE;
...
struct StackElementSystem :
    public LayoutElementSystem<
        hrz_jobs::SymbolBakingData::Stack,
...
struct FlexElementSystem :
    public LayoutElementSystem<
        hrz_jobs::SymbolBakingData::Flex,
