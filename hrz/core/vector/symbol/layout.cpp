    ...
    const std::function<uint32_t(const hrz_proto::SymbolElement&)>& make_child_prototype)
{
    ...
    for (const auto& component : descriptor.components())
    {
        ...
        {
            case HrzProtocol::TRANSFORM_SYMBOL_TRANSLATION:
            {
            ...
            case HrzProtocol::TRANSFORM_SYMBOL_ROTATION:
            {
            ...
            case HrzProtocol::TRANSFORM_SYMBOL_SCALING:
            {
            ...
            case HrzProtocol::TRANSFORM_SYMBOL_GENERIC:
            {
