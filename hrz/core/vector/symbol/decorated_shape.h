...
struct DecoratedShapeRenderable : public my::Renderer::Renderable
{
    lm::dvec3 center;
    double radius;
    ...
    struct RenderData
    {
        ...
        my::ResourceHandle decorated_shape_ubo = my::ResourceHandle::null();
...
struct DecoratedShapeElementSystem : public ElementSystem
{
private:
    struct Prototype
    {
        ...
        hrz_jobs::SymbolBakingData::DecoratedShape baking_params;
    };
    ...
    using RenderablePool = hrz::GenObjectPool<DecoratedShapeRenderable, RenderableIndexPool, 64>;
