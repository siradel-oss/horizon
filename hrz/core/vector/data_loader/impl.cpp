...
const char* VectorDataLoader::get_vector_data_provider_name(
    hrz_proto::VectorDataSource::ProviderTypeCase provider_type)
{
    switch (provider_type)
    {
        case hrz_proto::VectorDataSource::ProviderTypeCase::kTiledDataProvider:
            return "Tiled vector data";
        case hrz_proto::VectorDataSource::ProviderTypeCase::kClientDataProvider:
            return "Client vector data";
        case hrz_proto::VectorDataSource::ProviderTypeCase::kInMemoryDataProvider:
            return "In-memory vector data";
        case hrz_proto::VectorDataSource::ProviderTypeCase::kTilejsonDataProvider:
            return "TileJSON vector data";
        case hrz_proto::VectorDataSource::ProviderTypeCase::kUntiledDataProvider:
            return "Untiled vector data";
        case hrz_proto::VectorDataSource::ProviderTypeCase::kPmtilesDataProvider:
            return "PMTiles vector data";
        case hrz_proto::VectorDataSource::ProviderTypeCase::PROVIDER_TYPE_NOT_SET: break;
    ...
    uint64_t layer_handle)
{
    ...
    for (uint32_t s = 0; s < (uint32_t)layer.sources_size(); ++s)
    {
            ...
            == hrz_proto::VectorDataSource::ProviderTypeCase::kTiledDataProvider)
        {
            ...
            == hrz_proto::VectorDataSource::ProviderTypeCase::kClientDataProvider)
        {
            ...
            source.provider_type_case()
            == hrz_proto::VectorDataSource::ProviderTypeCase::kInMemoryDataProvider)
        {
        ...
        model_source.request_count_metric = metrics::MetricDesc(
            ...
            {{"layer", std::to_string(layer_handle)},
             ...
             {"format", get_vector_data_provider_name(source.provider_type_case())}});
...
void VectorDataLoader::work_client_request_timeouts()
{
    while (!client_tickets_timeouts.empty())
    {
        ...
        if (hrz::clock::CurrentFrameWallTime.ms >= request.timeout_date)
        {
