...
class ReprRegistry
{
    ...
    hrz::flat_hash_map<hrz_proto::VectorRepr::ReprTypeCase, std::unique_ptr<ReprSystem>> _reprs;
...
public:
    ...
    void register_repr(hrz_proto::VectorRepr::ReprTypeCase type, std::unique_ptr<ReprSystem> repr);
    ...
    ReprSystem& get(hrz_proto::VectorRepr::ReprTypeCase type);
};
