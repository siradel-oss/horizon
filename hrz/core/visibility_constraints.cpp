    ...
    const hrz_proto::LayerVisibilityConstraintList& visibility_constraints)
{
    ...
    {
        switch (constraint.constraint_type_case())
        {
            case hrz_proto::LayerVisibilityConstraint::ConstraintTypeCase::kBounds:
            {
            ...
            case hrz_proto::LayerVisibilityConstraint::ConstraintTypeCase::kAltitude:
            {
            ...
            case hrz_proto::LayerVisibilityConstraint::ConstraintTypeCase::CONSTRAINT_TYPE_NOT_SET:
                HRZ_LOG_ERROR("Unset visibility constraint.");
                break;
        }
    }
