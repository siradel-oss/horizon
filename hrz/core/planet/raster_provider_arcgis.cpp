...
public:
    ...
    {
        return hrz_proto::RasterProvider::ProviderTypeCase::kArcgis;
    }
...
private:
        ...
        AttributionHandle attribution)
    {
        ...
        else
        {
            ...
            geometry.projection.set_descriptor_type(hrz_proto::SrsDescriptorType::SRID_DESCRIPTOR);
    ...
    bool setup_provider(AttributionRegistry* attributions, std::span<const std::byte> raw_data)
    {
        ...
        tiling_scheme->set_border_tile_aspect(hrz_proto::BorderTileAspect::FULL_SIZED);
            ...
            fetcher.emplace(
                ...
                TileFetcher::MetricInfo{
                    provider_request_tally_metric_name(
                        hrz_proto::RasterProvider::ProviderTypeCase::kArcgis),
                    url.c_str()
                });
            return true;
        }
