...
struct RasterProvider
{
    ...
    enum class UpdateAction
    {
        ...
        // Re-fetches the source tiles and re-composes the final tile.
        // Use this when the source tiles have changed, but the geometry and projection
        // of the raster provider are still valid.
        RestartTiles,

        // Invalidates the whole provider and its tiles.
        RecreateProvider,
    };
    ...
    virtual hrz_proto::RasterProvider::ProviderTypeCase get_raster_provider_type() const = 0;
