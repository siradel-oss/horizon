...
struct UrlGenerator : public hrz::TileUrlGenerator
{
    ...
    std::string make_url(uint32_t x, uint32_t y, uint32_t z) override
    {
        ...
        if (geometry.tiling_scheme.scheme_type_case()
            ...
            && geometry.projection.descriptor_() == hrz_proj::wmerc_proj_str)
        {
            ...
            geometry.tiling_scheme.scheme_type_case()
                == hrz_proto::TilingSchemeParams::SchemeTypeCase::kGlobalTiling
...
public:
        ...
        download_ticket(0)
    {
        for (int i = 0; i < params.layers_size(); ++i)
        {
            ...
            layer_names.emplace_back(layer.layer_name());
            layer_styles.emplace_back(layer.style_name());
        }
        ...
        for (int i = 0; i < params.dimensions_size(); ++i)
        {
            ...
            dimension_values.emplace_back(dimension.value());
        }
    ...
    {
        return hrz_proto::RasterProvider::ProviderTypeCase::kWms;
    }
                    ...
                    fetcher.emplace(
                        ...
                        TileFetcher::MetricInfo{
                            provider_request_tally_metric_name(
                                hrz_proto::RasterProvider::ProviderTypeCase::kWms),
