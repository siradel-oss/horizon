...
unsigned int level_zero_tile_count_y(const hrz_proto::TilingSchemeParams& tiling_scheme)
{
    switch (tiling_scheme.scheme_type_case())
    {
        ...
        case hrz_proto::TilingSchemeParams::SchemeTypeCase::kLocalTiling: return 1;
...
public:
        ...
        fetcher(
            ...
            TileFetcher::MetricInfo{
                provider_request_tally_metric_name(
                    hrz_proto::RasterProvider::ProviderTypeCase::kTiled),
                params.url_pattern()
            }),
        geometry(
    ...
    {
        return hrz_proto::RasterProvider::ProviderTypeCase::kTiled;
    }
