...
TEST_F(FeatureStyling, set_colorize_numeric)
{
    ...
    auto color_stop = palette.mutable_numeric()->add_color_stops();
    color_stop->set_value(0.0F);
    color_stop->mutable_first_color()->CopyFrom(lower);
    color_stop->mutable_second_color()->CopyFrom(lower);
    ...
    color_stop = palette.mutable_numeric()->add_color_stops();
    color_stop->set_value(100.0F);
    color_stop->mutable_first_color()->CopyFrom(upper);
    color_stop->mutable_second_color()->CopyFrom(upper);
