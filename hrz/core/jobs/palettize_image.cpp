    ...
    const JobContext& context)
{
    ...
    switch (image_format)
    {
        ...
        case hrz_proto::ImageFormat::SIRADEL_LEGACY_F32:
            fetch_pixel_func = hrz::sampling::fetch_siradel_legacy_f32_pixel;
            break;
    ...
    size_t output_image_data_size = params.image.width() * params.image.height()
        * hrz::image_format_byte_count(hrz_proto::ImageFormat::SRGBA_8);
    ...
    response = hrz::BlobImage::make(
        hrz_proto::ImageFormat::SRGBA_8, params.image.width(), params.image.height(),
