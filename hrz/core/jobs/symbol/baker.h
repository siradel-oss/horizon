...
private:
    ...
    struct ElementVisitor
    {
        ...
        hrz_proto::SymbolElement::ElementTypeCase get_child_type(uint32_t index) const
        {
    ...
    hrz::flat_hash_map<hrz_proto::SymbolElement::ElementTypeCase, ElementVisitor*> element_visitors;
...
private:
    ...
    ElementVisitor* get_element_visitor_for_type(
        hrz_proto::SymbolElement::ElementTypeCase element_type)
    {
