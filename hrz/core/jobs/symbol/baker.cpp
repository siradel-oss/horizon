...
SymbolBaker::SymbolBaker(const hrz_jobs::SymbolBakingData& params, const JobContext& context) :
    ...
    max_feature_index(0)
{
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kPlaceholder] =
        &placeholder_visitor;
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kAnchor] = &anchor_visitor;
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kStack] = &stack_visitor;
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kImage] = &image_visitor;
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kPadding] = &padding_visitor;
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kFlex] = &flex_visitor;
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kSizedBox] = &sized_box_visitor;
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kFlexible] = &flexible_visitor;
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kStackExpand] =
        &stack_expand_visitor;
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kAlign] = &fitted_box_visitor;
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kConstrainedBox] =
        &constrained_box_visitor;
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kRotatedBox] = &rotated_box_visitor;
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kDecoratedShape] =
        &decorated_shape_visitor;
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kAspectRatio] =
        &aspect_ratio_visitor;
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kFittedBox] = &fitted_box_visitor;
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kTransform] = &transform_visitor;
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kText] = &text_visitor;
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kOptional] = &optional_visitor;
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kVariant] = &variant_visitor;
    element_visitors[hrz_proto::SymbolElement::ElementTypeCase::kLeaderLine] = &leader_line_visitor;
}
...
hrz_jobs::JobResult SymbolBaker::bake(hrz_jobs::BakedSymbols& baked_symbols)
{
    ...
    for (const auto& instance : style.instances.get_data())
    {
        ...
        for (size_t i = 0; i < params.elements.size(); ++i)
        {
            ...
            bool is_anchor = element.type == hrz_proto::SymbolElement::ElementTypeCase::kAnchor;
