...
class FixedTargetManipulator : public CameraManipulator
{
    ...
    public:
        explicit RotationController(const InitializedState& state, clock::ClockType clock_type) :
    ...
    public:
        MouseDragRotationController(
            ...
            RotationController(state, clock::kWallClock), _scene_view{scene_view}, _button{button}
        {
        }
    ...
    public:
        TouchDragRotationController(
            ...
            RotationController(state, clock::kWallClock),
