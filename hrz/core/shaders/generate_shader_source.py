...
out.write("static constexpr const unsigned char %s_%s_compressed_str[] = {\n" % (sys.argv[2], sys.argv[3]))
...
out.write("extern const size_t %s_%s_compressed_len = sizeof(%s_%s_compressed_str) - 1;\n" % (sys.argv[2], sys.argv[3], sys.argv[2], sys.argv[3]))
out.write("const unsigned char* %s_%s_compressed = %s_%s_compressed_str;\n" % (sys.argv[2], sys.argv[3], sys.argv[2], sys.argv[3]))
