...
Horizon provides limited support for Mapbox styles, using the [Mapbox service](HrzProtocol.MapboxService.html). It is able to parse a subset of the [Mapbox style specification](https://docs.mapbox.com/mapbox-gl-js/style-spec/) as a JSON string, create the corresponding layers and adjust the scene settings to replicate the intended behaviour on a best effort basis.
...
<gallery-card demo="mapbox"></gallery-card>
