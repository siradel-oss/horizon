...
struct DynamicMessage
{
    ...
    const google::protobuf::FieldDescriptor* _get_field_descriptor(
    ...
    const google::protobuf::OneofDescriptor* _get_oneof_descriptor(
        std::string_view field_name) const
    {
    ...
    DynamicMessage create_message(std::string_view full_type_name)
    {
    ...
    void remove_repeated(std::string_view field_name, int index)
    {
...
#define WRAPPER_TYPE(NAME, CPP, PB)                                                    \
    CPP get_##NAME(std::string_view field_name) const                                  \
    {                                                                                  \
...
#define WRAPPER_TYPE(NAME, CPP, PB)                                       \
    CPP get_repeated_##NAME(std::string_view field_name, int index) const \
    {                                                                     \
...
#define WRAPPER_TYPE(NAME, CPP, PB)                                                   \
    void set_##NAME(std::string_view field_name, CPP value)                           \
    {                                                                                 \
...
#define WRAPPER_TYPE(NAME, CPP, PB)                                             \
    void set_repeated_##NAME(std::string_view field_name, int index, CPP value) \
    {                                                                           \
...
#define WRAPPER_TYPE(NAME, CPP, PB)                                                   \
    void add_##NAME(std::string_view field_name, CPP value)                           \
    {                                                                                 \
