...
TEST(CommonPalette, numeric_palette_continuous)
{
    ...
    *numeric->mutable_nan_color() = global_colors.proto_red;
    ...
    {
        auto* color_stop = numeric->add_color_stops();
        color_stop->set_value(10.0);
        *color_stop->mutable_first_color() = global_colors.proto_white;
        *color_stop->mutable_second_color() = global_colors.proto_white;
    }

    {
        auto* color_stop = numeric->add_color_stops();
        color_stop->set_value(20.0);
        *color_stop->mutable_first_color() = global_colors.proto_black;
        *color_stop->mutable_second_color() = global_colors.proto_black;
    }
...
TEST(CommonPalette, numeric_palette_color_stop_edges)
{
    hrz_proto::Palette proto_palette;
    auto* numeric = proto_palette.mutable_numeric();
    ...
    *numeric->mutable_nan_color() = global_colors.proto_white;
    ...
    {
        auto* color_stop = numeric->add_color_stops();
        color_stop->set_value(0.0);
        *color_stop->mutable_first_color() = global_colors.proto_black;
        *color_stop->mutable_second_color() = global_colors.proto_red;
    }

    {
        auto* color_stop = numeric->add_color_stops();
        color_stop->set_value(0.5);
        *color_stop->mutable_first_color() = global_colors.proto_green;
        *color_stop->mutable_second_color() = global_colors.proto_black;
    }
    ...
    {
        auto* color_stop = numeric->mutable_color_stops(1);
        *color_stop->mutable_second_color() = global_colors.proto_green;
    }

    {
        auto* color_stop = numeric->add_color_stops();
        color_stop->set_value(1);
        *color_stop->mutable_first_color() = global_colors.proto_blue;
        *color_stop->mutable_second_color() = global_colors.proto_black;
    }
...
TEST(CommonPalette, numeric_palette_discrete)
{
    ...
    *numeric->mutable_nan_color() = global_colors.proto_white;
...

    {
        auto* color_stop = numeric->add_color_stops();
        color_stop->set_value(20.0);
        *color_stop->mutable_first_color() = global_colors.proto_red;
        *color_stop->mutable_second_color() = global_colors.proto_green;
    }

    {
        auto* color_stop = numeric->add_color_stops();
        color_stop->set_value(30.0);
        *color_stop->mutable_first_color() = global_colors.proto_green;
        *color_stop->mutable_second_color() = global_colors.proto_magenta;
    }
...
TEST(CommonPalette, invalid_palette_type)
{
    ...
    label_palette.mutable_label();

    hrz_proto::Palette numeric_palette;
    numeric_palette.mutable_numeric();
