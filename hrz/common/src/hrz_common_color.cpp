...
lm::vec4 srgb_to_oklab(const lm::vec4& srgb)
{
    ...
    lm::vec4 rgb_lin = hrz::srgb_to_linear(srgb);
...
lm::vec4 oklab_to_srgb(const lm::vec4& lms)
{
    ...
    return lm::vec4(hrz::linear_to_srgb(rgb_lin), lms.a);
}

lm::vec4 mix_srgb_colors(const lm::vec4& x, const lm::vec4& y, float t)
{
    lm::vec4 x_oklab = srgb_to_oklab(x);
    lm::vec4 y_oklab = srgb_to_oklab(y);

    lm::vec4 mix_oklab = lm::mix(x_oklab, y_oklab, t);

    return oklab_to_srgb(mix_oklab);
}
