...
struct SharedData
{
    ...
    void process_operations()
    {
        ...
        auto msgs = _pb_arena.Make<hrz_monitoring::MonitoringMessages>();
...
void hrz::metrics::MetricDesc::push_label(const char* name, std::string_view value)
{
