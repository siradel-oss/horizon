...
ARCHIVE_URL = f"https://github.com/google/copybara/archive/{version_without_suffix}.tar.gz"
...
if not run_command(["bazel", "--batch", "build", "--java_language_version=17", "//java/com/google/copybara:copybara_deploy.jar", "-c", "opt"], directory=source_dir):
...
copy_file(source_dir / "bazel-bin/java/com/google/copybara/copybara_deploy.jar", install_dir / "copybara.jar")
