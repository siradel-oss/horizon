...
let terrainSettings = reactive<HrzProtocol.TerrainSettings.$Properties>({
    disableTerrainElevation: false,
});
let rasterSettings = reactive<HrzProtocol.RasterSettings.$Properties>({});
        ...
        <template #left>
            <div class="typography-normal">
                ...
                <p>
                    ...
                    <a href="../doc/reference/HrzProtocol.RasterSettings.html">the documentation</a>
                ...
                <p>
                    DTM raster layers can be ignored entirely in the scene view, leading to a flat
                    ground at elevation zero. Other systems relying on DTM raster layers are
                    unaffected so the vertical position of buildings is kept.
                </p>
                <p v-if="terrainSettings.disableTerrainElevation !== undefined">
                    <label>
                        <input type="checkbox" v-model="terrainSettings.disableTerrainElevation" />
                        Disable DTM
                    </label>
                </p>
            </div>
