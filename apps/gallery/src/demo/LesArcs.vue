...
const layerPolygons = shallowRef<HrzProtocol.LayerHandle | undefined>(undefined);
const layerPolylines = shallowRef<HrzProtocol.LayerHandle | undefined>(undefined);
const layerLifts = shallowRef<HrzProtocol.LayerHandle | undefined>(undefined);
...
async function retrieveLayerModel(layer?: HrzProtocol.LayerHandle): Promise<any> {
    if (!layer || !api.value) {
        return {};
    }
            ...
            <div class="typography-normal">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        roads, streets, paths, hiking and MTB trails, etc. They are displayed using
