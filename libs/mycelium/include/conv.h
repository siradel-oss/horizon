...
namespace my
{
static GLenum to_gl(PrimitiveType p)
{
    switch (p)
    {
...
static GLint format_components(VertexFormat format)
{
    switch (format)
    {
...
static GLenum format_type(VertexFormat format)
{
    switch (format)
    {
        case VertexFormat::Int8:
...
static bool format_normalized(VertexFormat format)
{
    switch (format)
    {
        case VertexFormat::Int8:
...
static bool format_integer(VertexFormat format)
{
    switch (format)
    {
        case VertexFormat::Int8:
...
static size_t format_format(TextureFormat format)
{
    switch (format)
    {
...
static size_t format_type(TextureFormat format)
{
    switch (format)
    {
        case TextureFormat::R8I:
...
static size_t format_internal(TextureFormat format)
{
    switch (format)
    {
...
static GLenum to_gl(IndexType type)
{
    switch (type)
    {
...
static GLenum to_gl(UsageHint usage)
{
    switch (usage)
    {
...
static GLenum to_gl(TextureLayout::Type type)
{
    switch (type)
    {
...
static GLenum to_gl(SamplerParams::Wrap wrap)
{
    switch (wrap)
    {
...
static GLenum to_gl(my::RasterizationState::CullMode mode)
{
    switch (mode)
    {
...
static GLenum to_gl(my::RasterizationState::FrontFace face)
{
    switch (face)
    {
...
static GLenum to_gl(my::DepthState::Compare func)
{
    switch (func)
    {
...
static GLenum to_gl(my::StencilState::Compare func)
{
    switch (func)
    {
...
static GLenum to_gl(my::StencilState::Op op)
{
    switch (op)
    {
...
static GLenum to_gl(bool b)
{
    return b ? GL_TRUE : GL_FALSE;
}

static GLenum to_gl(ColorBlendState::Op op)
{
    switch (op)
    {
...
static GLenum to_gl(ColorBlendState::Factor factor)
{
    switch (factor)
    {
...
static GLenum to_gl(Attachment a)
{
    switch (a)
    {
...
static GLbitfield to_gl(AspectFlags aspects)
{
    GLbitfield gl = 0;
...
static GLenum buffer_resource_type_to_gl_target(Resource::Type type)
{
    switch (type)
    {
...
static TextureFormat to_texture_format(TextureDownloadFormat format)
{
    switch (format)
    {
...
static GLenum dl_format_format(TextureDownloadFormat format)
{
    switch (format)
    {
...
static GLenum dl_format_type(TextureDownloadFormat format)
{
    switch (format)
    {
