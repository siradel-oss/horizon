...
The documentation provides a [guide on how to get started](https://horizon.redacted.localhost/doc/getting_started.html).
...
Please see the [developer's documentation](https://horizon.redacted.localhost/doc/dev_guide/index.html) for information regarding development environment and workflow.
