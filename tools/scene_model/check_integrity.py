...
if __name__ == "__main__":
    ...
    for entry in MANIFEST.entries:
        ...
        if descriptor_hash != entry.descriptor_hash:
            print(f"Migration manifest integrity error at version {entry.id}: {entry.description}")
            print("The descriptor hash does not match the one declared in the manifest file")
    ...
    if hash1 != hash2:
        ...
        print("Please update the latest descriptor set with update_latest_version.py if it is compatible.")
