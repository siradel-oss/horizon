...
The website is built from the documentation and gallery assets of a release, and deployed to GitHub Pages at https://horizon.oss.siradel.com. Its sources live in the [horizon-website](https://github.com/siradel-oss/horizon-website) repository, and are fetched by the workflow.
