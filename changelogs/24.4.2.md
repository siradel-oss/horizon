...
* Added the `experimental_adaptive_resolution` parameter to [TerrainSettings]($proto). This parameter improves terrain rendering at high elevations. It is experimental and should not be used in production.
