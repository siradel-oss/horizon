...
* **Camera**
    ...
    * [Translation movements](HrzProtocol.CameraTranslate.html) now use a [frame](HrzProtocol.CameraFrame.html) and a 2-dimensional movement instead of an axis and a 1-dimensional movement.
