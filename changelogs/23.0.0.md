...
* **Memory management**
    ...
    * An option to allocate blobs using the system allocator (i.e. [malloc](https://en.cppreference.com/w/c/memory/malloc)) has been added in the [[ViewerOptions]]: `use_system_allocator_for_blobs`.
* **Styling scripts**
...
* **3D Tiles**
    ...
    * When using the `3DTILES_batch_table_hierarchy` extension, the class name and class ID of each batch can be used as attributes by using the corresponding [[ThreeDTileAttributeSource]] in [[ThreeDTileAttribute]].
...
* **Geographics coordinates**
    * The `Wgs84Bounds`, `Wgs84VolumeBounds` and `Wgs84ViewPolygon` messages have been renamed to [[GeographicBounds]], [[GeographicVolumeBounds]] and [[GeographicViewPolygon]].
* **Blend modes**
